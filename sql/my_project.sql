...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 07, 2018 at 08:35 PM
...
CREATE TABLE `booking` (
  ...
  `b_cus_id` int(11) NOT NULL,
  `b_pro_id` int(10) NOT NULL,
  `b_amount` int(10) NOT NULL,
  `b_paystatus` int(1) NOT NULL,
...
INSERT INTO `booking` (`b_id`, `b_cus_id`, `b_pro_id`, `b_amount`, `b_paystatus`, `b_status`) VALUES
(1, 1, 1, 111, 1, 1);
...
CREATE TABLE `customer` (
  ...
  `amphur` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `districts` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `tel` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `department` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `c_status` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `customer` (`c_id`, `username`, `password`, `fristname`, `lastname`, `address`, `province`, `amphur`, `districts`, `tel`, `department`, `c_status`, `level`) VALUES
(1, 'nantawat', '1234', 'เครื่องใหม่', 'เครื่องใหม่', 'เครื่องใหม่', '5', '84', '563', '0870792322', 'เครื่องใหม่', '1', 1),
(2, 'admin', '1234', 'นันทวัฒน์', 'ศิริวรรณ', '31 ม.1', '5', '84', '563', '0870792322', 'tonggnot', '1', 2);
...
CREATE TABLE `material` (
  ...
  `m_amount` int(10) NOT NULL,
  `m_unit` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `material` (`m_id`, `m_name`, `m_amount`, `m_unit`, `m_status`) VALUES
(1, 'แผ่นพลาสติก', 10000, 'เมตร', '1');
...
CREATE TABLE `news` (
  ...
  `news_topic` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `news_detail` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `news_pic` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `news_delstatus` int(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `news` (`news_id`, `news_topic`, `news_detail`, `news_pic`, `news_delstatus`) VALUES
(1, 'ทดสอบ', 'ทดสอบ', 'pic/36505402.jpg', 1),
(2, 'testadd', 'newdetail', 'pic/0abf71513ec2db668a79a3b1a9e3b934.jpg', 1);
...
INSERT INTO `orders` (`OrderID`, `OrderDate`, `customer_id`) VALUES
(00001, '2018-10-04 20:26:14', 1),
(00002, '2018-10-04 20:30:39', 1),
(00003, '2018-10-04 21:25:19', 1),
(00004, '2018-10-04 21:26:53', 3),
(00005, '2018-10-04 21:33:10', 1),
(00006, '2018-10-04 21:34:25', 1),
(00007, '2018-10-04 21:35:42', 1),
(00008, '2018-10-04 21:48:31', 12),
(00009, '2018-10-04 21:49:27', 55),
(00010, '2018-10-05 18:26:09', 1),
(00011, '2018-10-05 19:22:27', 1),
(00012, '2018-10-06 09:41:42', 555),
(00013, '2018-10-06 09:42:27', 555555),
(00014, '2018-10-06 09:45:32', 5555),
(00015, '2018-10-06 10:13:46', 99),
(00016, '2018-10-06 10:16:24', 1),
(00017, '2018-10-06 17:58:32', 1),
(00018, '2018-10-06 20:05:10', 1),
(00019, '2018-10-07 08:44:25', 1),
(00020, '2018-10-07 14:13:45', 1);
...
INSERT INTO `order_detail` (`DetailID`, `OrderID`, `p_id`, `qty`) VALUES
(1, 0000000006, 1, 1),
(2, 0000000007, 1, 10),
(3, 0000000007, 2, 10),
(4, 0000000008, 1, 20),
...
(9, 0000000011, 1, 1000),
(10, 0000000012, 1, 555),
(11, 0000000013, 1, 1110),
(12, 0000000013, 2, 555),
(13, 0000000014, 1, 1332),
(14, 0000000014, 2, 555),
(15, 0000000015, 1, 999),
(16, 0000000016, 1, 1),
(17, 0000000017, 1, 1),
...
CREATE TABLE `payment` (
  ...
  `pay_booking_id` int(10) NOT NULL,
  `pay_pic` varchar(500) COLLATE utf8_unicode_ci NOT NULL,
  `pay_type` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `pay_cus_id` int(10) NOT NULL,
  `pay_status` int(1) NOT NULL,
  `pay_delete` int(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `payment` (`pay_id`, `pay_booking_id`, `pay_pic`, `pay_type`, `pay_cus_id`, `pay_status`, `pay_delete`) VALUES
(6, 18, 'pic/36505402.jpg', '2', 1, 3, 1),
(7, 18, 'pic/0abf71513ec2db668a79a3b1a9e3b934.jpg', '2', 1, 1, 1);
...
CREATE TABLE `pay_status` (
  ...
  `pay_status_name` varchar(50) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, 'การชำระเงินผิดพลาด'),
(2, 'ยังไม่ได้รับการตรวจสอบ'),
(3, 'ตรวจสอบแล้ว');
...
CREATE TABLE `pay_type` (
  ...
  `pay_type_name` varchar(10) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `product` (
  ...
  `p_detail` varchar(300) COLLATE utf8_unicode_ci NOT NULL,
  `p_pic` varchar(300) COLLATE utf8_unicode_ci NOT NULL,
  `p_material` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `p_amount` int(50) NOT NULL,
...
INSERT INTO `product` (`p_id`, `p_name`, `p_detail`, `p_pic`, `p_material`, `p_amount`, `p_price`, `p_status`) VALUES
(1, 'สินค้า1', 'สินค้า1รายละเอียด', 'pic/4b30b35f8df3db92caa4c707abdfde9d.png', '1', 1000, 1, '1'),
(2, 'สั่ง', 'สั่ง', 'pic/4b30b35f8df3db92caa4c707abdfde9d.png', '1', 5000, 10, '1'),
(3, 'สินค้า03', 'ดีมาก', 'pic/36505402.jpg', '1', 1111111, 55, '1');
...
--
ALTER TABLE `orders`
  MODIFY `OrderID` int(5) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `order_detail`
--
ALTER TABLE `order_detail`
  MODIFY `DetailID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `pay_status`
  MODIFY `pay_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `pay_type`
--
ALTER TABLE `pay_type`
  MODIFY `pay_type_id` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
