    ...
    <ul class="nav navbar-nav navbar-left">
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="display_booking.php">ข้อมูลการจองสินค้า</a></li>
