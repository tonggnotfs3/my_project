...
<body>
    ...
    <div class="container">
        ...
        $sql="SELECT * FROM orders INNER JOIN customer ON orders.customer_id = customer.c_id INNER JOIN payment ON orders.OrderID = payment.pay_booking_id WHERE payment.pay_status = 3 ORDER BY `orders`.`OrderID` DESC";
