        ...
        <tbody>
          ...
          <tr>
            <form action="cart_order.php" method="post">
              ...
              <th>
                <input type="hidden" name="txtProductID" value="<?php echo $row['p_id'];?>" size="2"> <input class="form-control"
                  type="text" name="txtQty" value="1" size="2"> <input class="btn btn-info" type="submit" value="สั่ง"></td>
              </th>
            </form>
          </tr>
          <?php } ?>
